...
<?php $sql = "SELECT calon_ketum.nim, calon_ketum.nama_calon, calon_ketum.tmp_lhr, calon_ketum.tgl_lahir, calon_ketum.agama, calon_ketum.visi, calon_ketum.misi, tblevent.nama_event from calon_ketum, tblevent where tblevent.id_event = calon_ketum.id_event";
$query = $dbh -> prepare($sql);
$query->execute();
