									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
												<?php 
													$sql1 ="SELECT id_organisasi from organisasi ";
													$query1 = $dbh -> prepare($sql1);;
													$query1->execute();
													$results1=$query1->fetchAll(PDO::FETCH_OBJ);
													$totalorganisasi=$query1->rowCount();
												?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($totalorganisasi);?></div>
													<div class="stat-panel-title text-uppercase">Organisasi</div>
												</div>
											</div>
											<a href="manage-organisasi.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
												<?php 
												$sql2 ="SELECT nim from calon_ketum ";
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
													<?php 
													$sql4 ="SELECT id from tblauth ";
													$query4 = $dbh -> prepare($sql4);
													$query4->execute();
													$results4=$query4->fetchAll(PDO::FETCH_OBJ);
													$totalevent=$query4->rowCount();
													?>												
													<div class="stat-panel-number h1 "><?php echo htmlentities($totalevent);?></div>
													<div class="stat-panel-title text-uppercase">Admin Organisasi</div>
												</div>
											</div>
											<a href="manage-adminorg.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
