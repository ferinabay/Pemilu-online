...
if(isset($_POST['submit']))
  	{
		...
		$sql="INSERT INTO tblauth(username,password,id_organisasi,userType) VALUES (:username,:password,:id_organisasi,:userType)";
...
<head>
	...
	<title>Pemilu Polinema | Tambah Admin </title>
									...
									<div class="panel-body">
										<form method="post" class="form-horizontal" enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" name="password" id="passwordd" class="form-control" required>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-4">
													<select class="selectpicker" data-size="4" name="id_organisasi" id="nama_org" required>
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" name="userType" id="passwordd" class="form-control" required>
												</div>
											</div>
											<div class="form-group">
