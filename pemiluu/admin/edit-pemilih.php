...
if(isset($_POST['submit']))
  {
	...
	$sql="update mhs set  nim=:nim,nama_lengkap=:nama_lengkap,password=:password,id_organisasi=:id_organisasi,id_event=:id_event where idmhs=:idmhs";
