										...
										<div class="panel panel-default">
											<div class="panel-body bk-primary text-light">
												<div class="stat-panel text-center">
													<?php 
														$sql ="SELECT mhs.nim from mhs join tblauth on mhs.id_organisasi=tblauth.id_organisasi where mhs.id_organisasi = 310 ";
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
													<?php 
														$sql2 ="SELECT calon_ketum.idcalon from calon_ketum join tblauth on calon_ketum.id_organisasi=tblauth.id_organisasi where calon_ketum.id_organisasi = 310";
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												<div class="stat-panel text-center">
													<?php 
													$sql3 ="SELECT tblevent.id_event from tblevent join tblauth on tblevent.id_organisasi=tblauth.id_organisasi where tblevent.id_organisasi = 310";
