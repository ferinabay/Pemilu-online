...
if(isset($_POST['submit']))
  {
	...
	$sql="update calon_ketum set nama_calon=:nama_calon,tmp_lhr=:tmp_lhr,tgl_lahir=:tgl_lahir,agama=:agama,visi=:visi,misi=:misi,CKimage=:CKimage,id_event=:id_event where nim=:nim";
					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
										...
										<?php 
											$nim=intval($_GET['nim']);
											$sql ="SELECT calon_ketum.*,tblevent.nama_event, tblevent.id_event as bid 
															from calon_ketum join tblevent 
															on calon_ketum.id_event = tblevent.id_event
															where calon_ketum.nim=:nim AND calon_ketum.id_organisasi = 310";
											$query = $dbh -> prepare($sql);
											$query-> bindParam(':nim', $nim, PDO::PARAM_STR);
											$query->execute();
