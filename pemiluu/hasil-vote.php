        ...
        <div role="tabpanel" class="tab-pane active" id="id_caketum">
            ...
            <div class="col-list-3">
              <div class="recent-car-list">
                ...
                <div class="car-title-m text-center" style="padding-top:0px;">
                <?php 
                          $id_event=intval($_GET['id_event']);
													$sql ="SELECT idmhs from mhs where mhs.statuspilih=1 ";
													$query = $dbh -> prepare($sql);
													$query->execute();
													$results=$query->fetchAll(PDO::FETCH_OBJ);
													$totalsuara=$query->rowCount();
									?>
									<div class="stat-panel-number h1" style="margin-top:0px;"><?php echo htmlentities($totalsuara);?></div>
                  <div class="stat-panel-title text-uppercase">Suara</div>
                </div>
