...
if(isset($_POST['signup']))
{
  ...
  $makanan_fav = $_POST['makanan_fav'];
  
  $sql="INSERT INTO mhs(nim, nama_lengkap, nama_ibu,makanan_fav) VALUES(:nim, :nama_lengkap, :namaibu, :makanan_fav) WHERE nim=:nim";
  
  $query = $dbh->prepare($sql);
  $query->bindParam(':nim',$nim,PDO::PARAM_STR);
  $query->bindParam(':nama_lengkap',$nama_lengkap,PDO::PARAM_STR);
  $query->bindParam(':nama_ibu',$nama_ibu,PDO::PARAM_STR);
  $query->bindParam(':makanan_fav',$makanan_fav,PDO::PARAM_STR);
  $query->execute();
          ...
          <div class="signup_wrap">
            <div class="col-md-12 col-sm-6">
              <form  method="post" name="signup" onSubmit="return valid();">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="makanan_fav" placeholder="Makanan Fav"  required="required">
                </div>
